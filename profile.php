                    ...
                    <form id="info-form">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="first_name" value="<?php echo $u_fetch['first_name']?>" class="form-control shadow-none" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Last Name</label>
                                <input type="text" name="last_name" value="<?php echo $u_fetch['last_name']?>" class="form-control shadow-none" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Date of Birth</label>
                                <input type="date" name="dob" value="<?php echo $u_fetch['dob']?>" class="form-control shadow-none" placeholder="" required>
                            </div>
