...
<body>
    <div class="login-form text-center rounded bg-white shadow overflow-hidden">
        <form method="POST">
            <h4 class="text-dark py-3" style="background-color:  rgb(128,242,58);">ADMIN LOGIN PANEL</h4>
            <div class="p-4">
                ...
                <button class="btn custom-bg shadow-none text-dark" name='login'type='submit'>LOGIN</button>
            </div>
        </form>
    </div>
